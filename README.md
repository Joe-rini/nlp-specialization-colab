...
My contribution was to try to make the core ideas of the course more intuitive with clear toy examples, detailed plain language explanations, and fully runnable Google Colab notebooks so you can simply open a notebook and get started. Even if you are taking the DeepLearning.ai course (paid, or just auditing it for free) I suggest you additionally work through the Colab "lessons" I have created while working through the videos.
